...
- **Using welcoming and inclusive language** - avoid slurs or language that excludes
- **Being constructive** in feedback and criticism
- **Focusing on the code, not the person** when providing technical feedback
- **Showing empathy** toward other community members
- **Respecting privacy** and handling confidential information appropriately
- **Accepting responsibility** and apologizing when mistakes are made
- **Focusing on what is best** for the community

Examples of unacceptable behavior include:

- **Harassment** of any kind - including but not limited to unwelcome comments, threats, or attacks
...
**How to Report:**
1. Contact maintainers directly via email or GitHub
2. Provide detailed information about the incident
3. Include any relevant documentation (screenshots, messages, etc.)
4. Maintain confidentiality during the investigation

All project maintainers are obligated to maintain the confidentiality of the reporter of any incident.
